...
All builds were created and tested using the PlatformIO IDE extension for VSCode and Espressif ESP8266 12-E board, mileage may vary using other boards and IDE's.
